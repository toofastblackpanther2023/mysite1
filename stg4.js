...
function pageChange(event) {
  if (event.keyCode === 32) {
    window.location.href = "stg5.html"; // [スペースキー]が押されたら新しいページに遷移
  }
}
...
function mainloop() {
  ...
  switch (idx) {
    ...
    case 1: //ゲーム中
      ...
      if (tmr < 30 * 4) fText("STAGE4  "  , 600, 300, 50, "cyan");
  ...
  fText("『予算金額』の『入力間違い』をしないための取り組みで『不適切』なのはどれですか？ ", 600, 150, 30, "white");
}
